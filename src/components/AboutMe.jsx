...
const AboutMe = () => {
    return (
        <section id="about" className="relative z-10 -mt-8 sm:-mt-10 bg-black text-white py-20 px-6 rounded-t-[50px] border-t border-zinc-800 md:px-2 lg:px-25 w-full flex flex-col items-center">
